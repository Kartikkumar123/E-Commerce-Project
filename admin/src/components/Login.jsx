...
export default function Login({setToken}) {
  ...
  const onSubmitHandler = async (e)=>{
    try {
      e.preventDefault();
      const response= await axios.post('https://e-commerce-project-3-g71d.onrender.com/api/user/admin',{email,password})
  ...
  return (
    <div className='min-h-screen flex items-center justify-center w-full'>
      <div className='bg-whiet shadow-md rounded-lg px-8 py-6 max-w-md'>
